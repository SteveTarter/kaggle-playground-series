...
class ModelVisualizer:
    """
    Centralizes visualization logic for Gradient Boosting (LightGBM, XGBoost, CatBoost, HistGradientBoosting)
    and Neural Network models in PS-S06E09.
    """
    ...
    def plot_learning_curves(self, eval_results, metric='auc', metric_period=1):
        ...
        candidates = [
            ...
            'l2', 'auc', 'AUC', 'TotalF1', 'balanced_accuracy', 'loss', 'score', 'logloss'
        ]
        ...
        for i, model_item in enumerate(models):
            ...
            try:
                ...
                # Permutation Importance fallback
                    ...
                    if i == 0:
                        print(f"Note: {type(model).__name__} does not store tree feature_importances_ directly.")
                    continue
