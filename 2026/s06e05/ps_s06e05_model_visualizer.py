...
class ModelVisualizer:
    ...
    def plot_learning_curves(self, eval_results, metric='rmse', metric_period=1):
        """
        ...
        candidates = [
            ...
            'RMSE', 'rmse', 'RootMeanSquaredError', 'l2', 'auc', 'TotalF1', 'mlogloss'
        ]
        ...
        for i, result in enumerate(eval_results):
            ...
            if val_data is not None:
                ...
                # We subtract 1 because the first point is iteration 0
                total_iters = (len(val_data) - 1) * metric_period
                x_val = np.linspace(0, total_iters, len(val_data))
    ...
    def plot_multiclass_roc_curve(self, y_true, y_score, title='Multiclass ROC Curve (One-vs-Rest)'):
        ...
        Args:
            ...
            y_score: Target scores, can either be probability estimates of the positive class,
                     confidence values, or non-thresholded measure of decisions.
        """
        # Mapping for descriptive legend
        ...
        for i in range(n_classes):
            ...
            roc_auc = auc(fpr, tpr)
            plt.plot(fpr, tpr, label=f'{class_names[i]} Need (AUC = {roc_auc:.2f})')
